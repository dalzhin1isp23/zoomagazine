...
const Offers = () => {
  const products = [
    { id: 'offer_1', title: 'Корм Whiskas', price: 20, oldPrice: 50, discount: '50%', img: whiskas },
    { id: 'offer_2', title: 'Корм Whiskas для котят', price: 25, oldPrice: 55, discount: '45%', img: whiskas },
    { id: 'offer_3', title: 'Корм Whiskas с лососем', price: 22, oldPrice: 52, discount: '48%', img: whiskas },
    { id: 'offer_4', title: 'Корм Whiskas ассорти', price: 24, oldPrice: 54, discount: '46%', img: whiskas },
  ];
